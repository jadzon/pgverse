...
def detect_electrical_symbols(model_path, image_path, conf_threshold=0.25):
...
def process_circuit_diagrams(model_path, images_dir, output_dir="detections", conf_threshold=0.25):
...
if __name__ == "__main__":
    ...
    model_path = "handwritten_model/handwritten.pt"
    
    # Path to the circuit diagram image you want to analyze
    images_dir = "dataset/circuit/"
    
    # Run detection
    results = process_circuit_diagrams(model_path, images_dir)
